...
export default function App() {
  ...
  return (
    <div className={`w-screen min-h-screen font-sans ${theme === 'dark' ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-900'} flex flex-col transition-colors duration-200 overflow-x-hidden`}>
