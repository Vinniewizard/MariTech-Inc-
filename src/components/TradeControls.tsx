...
export default function TradeControls({
  ...
  return (
    <div className={`flex flex-col rounded-xl border p-5 shadow-sm max-w-full md:w-80 space-y-4 shrink-0 transition-colors ${
      isDark ? 'border-zinc-800 bg-zinc-950 text-white' : 'border-gray-200 bg-white text-black'
    }`}>
      ...
      <div className="relative">
        ...
        <button
          ...
          className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-xs font-bold cursor-pointer transition-all border ${
            isDark ? 'bg-zinc-900 border-zinc-800 text-zinc-105 hover:bg-zinc-850' : 'bg-gray-50 border-gray-150 text-black hover:bg-gray-100'
          }`}
        >
        ...
        {showAssetList && (
          <div className={`absolute left-0 mt-1.5 w-full rounded-lg border p-2 shadow-2xl z-40 max-h-72 overflow-y-auto ${
            isDark ? 'border-zinc-800 bg-zinc-900' : 'border-gray-250 bg-white'
          }`}>
            <input
              type="text"
              ...
              className={`w-full rounded-md px-2.5 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-black mb-2 border ${
                isDark ? 'bg-zinc-950 border-zinc-800 text-white placeholder-zinc-500' : 'bg-gray-50 border-gray-200 text-black placeholder-gray-400'
              }`}
            />
                ...
                <div
                  ...
                  className={`flex items-center justify-between rounded p-2 text-xs cursor-pointer transition-all ${
                    selectedAsset.id === asset.id
                      ? isDark ? 'bg-zinc-800 text-white font-bold' : 'bg-black text-white font-bold'
                      : isDark ? 'hover:bg-zinc-800 text-zinc-300' : 'hover:bg-gray-50 text-gray-800'
                  }`}
                >
                  <div>
      ...
      <div>
        ...
        <div className={`grid grid-cols-3 gap-1 rounded-md p-1 border ${
          isDark ? 'bg-zinc-900 border-zinc-850' : 'bg-gray-100/50 border-gray-150'
        }`}>
            ...
            <button
              ...
              className={`rounded py-1.5 text-[9px] font-bold uppercase transition-all tracking-tight cursor-pointer ${
                contractType === type
                  ...
                  : 'text-gray-450 hover:text-black hover:bg-white/20'
              }`}
            >
              ...
              <button
                ...
                className={`rounded py-1.5 text-[10px] font-mono font-bold border transition-all cursor-pointer ${
                  targetDigit === d
                    ...
                    : isDark ? 'border-zinc-800 bg-zinc-900 text-zinc-400 hover:bg-zinc-800' : 'border-gray-200 bg-gray-50 text-gray-500 hover:bg-gray-100'
                }`}
              >
                {d}
              </button>
            ...
            <button
              ...
              className={`rounded py-1 text-[9px] font-bold uppercase tracking-tight cursor-pointer ${
                durationUnit === unit
                  ...
                  : 'text-gray-410 hover:text-black hover:bg-white/10'
              }`}
            >
              {unit}
            </button>
        ...
        <div className="space-y-1.5 transition-all">
          ...
          <div className={`flex rounded-md border items-center ${
            ...
            <input
              ...
              className="w-full bg-transparent py-2.5 px-3 font-mono text-xs font-bold focus:outline-none text-right text-purple-650"
            />
          </div>
        </div>
      )}
      ...
      <div className="space-y-2">
        ...
        <div className={`flex rounded-md border items-center px-2.5 h-10 ${
          isDark ? 'bg-zinc-900 border-zinc-800' : 'bg-gray-50 border-gray-200 focus-within:border-black'
        }`}>
            ...
            <button
              ...
              className={`rounded py-1 text-[9px] font-bold hover:bg-black hover:text-white transition-all cursor-pointer border ${
                stake === preset
                  ...
                  : isDark ? 'border-zinc-800 bg-zinc-900 text-zinc-400 hover:bg-zinc-800' : 'border-gray-200 bg-gray-50/50 text-gray-450 hover:bg-gray-100'
              }`}
            >
              ${preset}
            </button>
      ...
      <div className={`rounded-lg p-3.5 border space-y-2 text-xs transition-colors ${
        isDark ? 'bg-zinc-900/60 border-zinc-855' : 'bg-gray-50/50 border-gray-100'
      }`}>
        ...
        {contractType === 'higher-lower' && (
          <>
            ...
            <button
              ...
              className="group flex w-full items-center justify-between rounded-md bg-slate-900 hover:bg-black text-white py-3 px-4 shadow-sm transition-all cursor-pointer font-sans"
            >
              <div className="flex flex-col text-left">
                <span className="text-xs font-extrabold uppercase tracking-wider">
                  HIGHER ▲
                </span>
                <span className="text-[9px] text-gray-200">Spot ends above barrier offset</span>
              </div>
              <div className="text-right font-mono font-bold text-xs">
                ${payoutPotential.toFixed(2)}
              </div>
            ...
            <button
              ...
              className="group flex w-full items-center justify-between rounded-md bg-slate-800 hover:bg-slate-900 text-white py-3 px-4 shadow-sm transition-all cursor-pointer font-sans"
            >
              <div className="flex flex-col text-left">
                <span className="text-xs font-extrabold uppercase tracking-wider">
                  LOWER ▼
                </span>
                <span className="text-[9px] text-gray-200">Spot ends below barrier offset</span>
              </div>
              <div className="text-right font-mono font-bold text-xs">
                ${payoutPotential.toFixed(2)}
              </div>
          ...
          <>
            ...
            >
              <div className="flex flex-col text-left">
                ...
                <span className="text-[9px] text-gray-200">Touches barrier spot during term</span>
              </div>
              <div className="text-right font-mono font-bold text-xs">
                ${payoutPotential.toFixed(2)}
              </div>
            ...
            <button
              ...
              className="group flex w-full items-center justify-between rounded-md bg-gray-100 hover:bg-gray-200 text-black py-3 px-4 border border-gray-200 shadow-sm transition-all cursor-pointer font-sans"
            >
              <div className="flex flex-col text-left">
                <span className="text-xs font-bold uppercase tracking-wider">
                  NO TOUCH ✖
                </span>
                <span className="text-[9px] text-gray-500">Never touches barrier offset</span>
              </div>
              <div className="text-right font-mono font-bold text-xs text-black animate-none">
                ${payoutPotential.toFixed(2)}
              </div>
            </button>
          </>
        ...
        {contractType === 'digit-over-under' && (
          <>
            ...
            <button
              ...
              className="group flex w-full items-center justify-between rounded-md bg-purple-600 hover:bg-purple-700 text-white py-3 px-4 shadow-sm transition-all cursor-pointer font-sans"
            >
              <div className="flex flex-col text-left">
                <span className="text-xs font-extrabold uppercase tracking-wider">
                  DIGIT OVER ▲
                </span>
                <span className="text-[9px] text-purple-100">Last digit {'>'} {targetDigit}</span>
              </div>
              <div className="text-right font-mono font-bold text-xs">
                ${payoutPotential.toFixed(2)}
              </div>
            ...
            <button
              ...
              className="group flex w-full items-center justify-between rounded-md bg-purple-800 hover:bg-purple-900 text-white py-3 px-4 shadow-sm transition-all cursor-pointer font-sans"
            >
              <div className="flex flex-col text-left">
                <span className="text-xs font-extrabold uppercase tracking-wider">
                  DIGIT UNDER ▼
